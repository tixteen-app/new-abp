...
//             <div
//               key={link.name}
//               className="flex items-center text-md font-medium text-black opacity-50 pointer-events-none transition-colors duration-200 group"
//             >
//               {link.name}
...
//             <div
//               key={link.name}
//               className="flex items-center text-base font-medium text-black opacity-50 pointer-events-none transition-colors duration-200"
//             >
//               {link.name}
//               <ChevronRight className="ml-1 h-4 w-4" />
//             </div>
